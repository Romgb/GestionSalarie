...
namespace SalariesDll
{
    ...
    public class Salarie
    {
       ...
       /// <summary>
       /// Vérifie que le TauxCS respecte les règles suivantes
       /// Doit être compris entre 0m et 0.6m
       /// </summary>
       /// <param name="value"></param>
       /// <returns></returns>
        public static bool IsTauxCSValide(decimal value)
        {
            if ((value < 0) || (value > 0.6m))
            {
                return false;
        ...
        public static bool IsSalaireValide(decimal value)
        {
        ...
        /// Longueur 7 structure nnXXXnn ou n est un digit et X une lettre
        /// </summary>
